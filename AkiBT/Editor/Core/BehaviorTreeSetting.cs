...
{
    public const string k_BehaviorTreeSettingsPath = "Assets/Gizmos/AkiBT/AkiBTSetting.asset";
    ...
    {
        var settings = AssetDatabase.LoadAssetAtPath<BehaviorTreeSetting>(k_BehaviorTreeSettingsPath);
        if (settings == null)
        {
            settings = ScriptableObject.CreateInstance<BehaviorTreeSetting>();
            AssetDatabase.CreateAsset(settings, k_BehaviorTreeSettingsPath);
